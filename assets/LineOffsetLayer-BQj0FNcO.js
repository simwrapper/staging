import{t as e}from"./line-layer-DaBTU5I4.js";var t=`#version 300 es
...
`,n={NONE:0,LEFT:1,RIGHT:-1},r={name:`udata`,vs:`uniform udataUniforms {
  float offsetDirection;
} udata;
`,uniformTypes:{offsetDirection:`f32`}},i=class extends e{initializeState(){super.initializeState()}getShaders(){let e=super.getShaders();return e.vs=t,e.modules=[...e.modules,r],e}updateState(e){let{props:t,oldProps:n,changeFlags:r}=e;super.updateState(e);let i={offsetDirection:t.offsetDirection};for(let e of this.getModels())e.shaderInputs.setProps({udata:i})}};i.layerName=`LineOffsetLayer`,i.defaultProps={bearing:0,offsetDirection:n.RIGHT};export{n,i as t};